...
<Card title="List Conversations" href="/endpoints#conversations" icon="messages-square">
`GET /v1/conversations`
</Card>

<Card title="List Deals" href="/endpoints#deals" icon="handshake">
`GET /v1/deals`
</Card>

<Card title="List Accounts" href="/endpoints#accounts" icon="building-2">
`GET /v1/accounts`
</Card>

<Card title="List Messages" href="/endpoints#messages" icon="mail">
`GET /v1/messages`
</Card>

<Card title="List Rows" href="/endpoints#rows" icon="rows-3">
`GET /v1/rows`
</Card>

<Card title="List Documents" href="/endpoints#documents" icon="file-text">
`GET /v1/documents`
</Card>
